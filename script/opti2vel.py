...
class VelocityBody:
    ...
    def __init__(self):
        ...
        self.acc_pub = rospy.Publisher("outer_acc", TwistStamped, queue_size = 10)# topic 
        self.pos_pub = rospy.Publisher("outer_position", PoseStamped, queue_size = 10)
        self.rate_pub = rospy.Publisher("outer_rate", TwistStamped, queue_size = 10)
        self.vel_error_pub = rospy.Publisher("outer_error", TwistStamped, queue_size= 10)
    ...
    def posCb(self, msg):
        self.pub_time = msg.header.stamp
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        outer_velocity.header.stamp = cnt.pub_time
        print(cnt.pub_time.to_sec())
